...
TEST(AttitudeManager_OutputMixing, CannotReturnOutOfRangeValuesWhenGivenValidInput) {
	...
	ASSERT_TRUE( (mixedOutput[ELEVATOR_OUT_CHANNEL] <= 100.0f ) && (mixedOutput[ELEVATOR_OUT_CHANNEL] >= -100.0f ) );
	ASSERT_TRUE( (mixedOutput[RUDDER_OUT_CHANNEL] <= 100.0f ) && (mixedOutput[RUDDER_OUT_CHANNEL] >= -100.0f ) );
