...
// void decode(std::vector<uint8_t> rawData, Telemetry_PIGO_t* decodedData) {
...
//     mavlink_encoding_status_t e1 = Mavlink_airside_encoder(MESSAGE_ID_EULER_ANGLE_PLANE, encodedData, static_cast<const uint8_t*>(static_cast<void*>(&planeAngleCommand)));
