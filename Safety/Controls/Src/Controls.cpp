...
PID_Output_t *runControlsAndGetPWM(Instructions_t * instructions, SFOutput_t * SF_pos) {
    ...
    // to return PID
    TEMPORARY_OUT_REMOVE_THIS.backLeftMotorPercent = 20;
    TEMPORARY_OUT_REMOVE_THIS.frontLeftMotorPercent = 20;
    TEMPORARY_OUT_REMOVE_THIS.backRightMotorPercent = 20;
    TEMPORARY_OUT_REMOVE_THIS.frontRightMotorPercent = 20;
