...
I2CPort::I2CPort(I2CPortNum port_num, I2CSpeed speed, I2CAddress address){
	...
	sda = GPIOPin(I2C1_SDA_PORT, I2C1_SDA_PIN_NUM, GPIO_ALT_OD, GPIO_STATE_LOW, GPIO_RES_PULLUP, GPIO_SPEED_FAST, GPIO_AF1_I2C1);
	scl = GPIOPin(I2C1_SCL_PORT, I2C1_SCL_PIN_NUM, GPIO_ALT_OD, GPIO_STATE_LOW, GPIO_RES_PULLUP, GPIO_SPEED_FAST, GPIO_AF1_I2C1);
}
